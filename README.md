...
```javascript
import iterNoneBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-none-by@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/iter-none-by/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/iter-none-by/actions/workflows/test.yml?query=branch:v0.2.3
